...
from src.mod_02_query_schedule import get_departure_times_of_day_json_list, trip_scheduled_departure_time, trip_scheduled_departure_time_sqlite
...
class TestSchedulesModuleFunctions(unittest.TestCase):
    ...
    def test_trip_scheduled_departures_time_sqlite(self):
        # Takes to arguments: trip_id, station
        # Must accept both 7 and 8 digits stations
        # trip_id: DUASN124705F01001-1_408049
        # station: 8727605 // 8727605*
        ...
        trip_id = "DUASN124705F01001-1_408049"
        station_id = "8727605"
        result1 = trip_scheduled_departure_time_sqlite(trip_id, station_id)
        self.assertEqual(result1, "04:06:00")
